...
const PageCta = ({ to }: PageCtaProps) => {
  ...
  return (
    <section id="contact" className="relative py-24 overflow-hidden bg-gradient-cta">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[700px] max-w-full h-[440px] rounded-full bg-blob-accent blur-3xl pointer-events-none opacity-80" />
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 sm:px-12 text-center">
        ...
        <Link
          ...
          className="inline-block bg-gradient-cta-button text-primary-foreground font-semibold px-8 py-3.5 rounded-[14px] hover:shadow-glow transition-all duration-300 hover:-translate-y-1"
        >
          {t("cta.button")}
        </Link>
        </div>
